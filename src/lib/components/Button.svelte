...
<style>
	.btn { display:inline-flex; align-items:center; gap:.5rem; padding:.55rem 1rem; border-radius:10px; font-weight:600; cursor:pointer; border:1px solid transparent; transition:transform .06s, box-shadow .08s, opacity .08s; user-select:none; }
	.btn:active { transform: translateY(1px); }
	.btn--primary { background:#0b84ff; color:#fff; border-color: rgba(11,132,255,.15); box-shadow: 0 6px 18px rgba(11,132,255,.12); }
	.btn--secondary { background:transparent; color:#0b84ff; border-color: rgba(15,23,42,.06); }
